...
const faqs = [
  {
    ...
    a: "呢個課程就係專門為零經驗嘅人設計。你唔需要任何技術背景，全程有導師一對一陪住你，從開帳號到完成作品。",
  },
  {
  ...
  {
    q: "除咗學費，仲有冇其他費用？",
    a: "需要訂閱付費 AI 工具。免費帳號嘅用量唔夠應付實際需要。性價比較高嘅方案係分別訂閱 Claude 同 ChatGPT 嘅 US$20 月費 plan，兩個合共每月大約 HK$400。導師會喺課堂上幫你揀最適合嘅方案。",
  },
  {
    q: "我需要咩電腦？iPad 得唔得？",
    a: "iPad 暫時仲未適合寫 code，最起碼需要一部 MacBook 或者 Windows 手提電腦。如果你暫時未有電腦，導師有舊 MacBook 可以喺課堂時借用，試過先再決定。導師會幫你分析實際需要。",
  },
  {
    q: "AI 成日更新，學完會唔會好快過時？",
    a: "課程教嘅係「內功心法」，即係點樣思考問題、點樣同 AI 溝通嘅底層邏輯。呢啲基本功唔會因為 AI 版本更新而過時。就好似學識揸車之後，換新車都識揸。",
  },
  {
    q: "上完體驗課可以唔繼續嗎？",
    a: "完全可以，零壓力。完成之後你已經帶走可長期使用嘅 AI 帳號。如果鍾意想繼續，即場補三堂就可以用套餐價上齊四堂。",
  },
  {
    q: "四堂上完仲想繼續點算？",
    a: "如果你想有導師繼續帶住做更大型或者長期嘅作品，可以再買四堂套餐，按自己進度決定。",
  },
  {
    q: "上完課之後有問題點算？",
    a: "課程嘅目標就係教你識得自己問 AI 搵答案。上完堂之後，AI 就係你 24 小時嘅技術顧問，有問題隨時問佢。",
  },
];
